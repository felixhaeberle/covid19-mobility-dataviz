...
class Heatmap {
  setup() {
    this.width = 1500;
    this.height = 500;
    this.margin = { left: 50, top: 50, right: 0, bottom: 0 };
    ...
    //Read the data
    Promise.all([d3.csv("/assets/data/neckartor.csv")]).then(
  ...
  dataLoaded(data) {
    ...
    function calendarHeatmap() {
      ...
      function chart() {
        ...
        var dateRange = ((d3.time && d3.time.days) || d3.timeDays)(
          yearAgo,
          now
        ...
        function drawChart() {
          ...
          var monthLabels = svg
            ...
            .attr("y", 170); // fix these to the top
    ...
    const dateValues = data[0].map((dv) => ({
